...
class Sudoku {
   private:
    ...
    bool attemptSolutions();
    bool existsInRow(int n, int row);
    bool existsInCol(int n, int col);
    bool existsInSquare(int n, int row, int col);
    bool isValidPlacement(int n, int row, int col);
